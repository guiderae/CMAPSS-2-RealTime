...
class PredictManager:
    ...
    def predict(cls, unit=None):
        ...
        # background thread is concurrently swapping/mutating it (see
        # realtime/process_realtime_training.py) -- without this, a
        # predict during a live-training run could hit a mid-swap model
        # or garbage weights instead of a clean error.
